...
<main class="blog">
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="row blog-post-row">
                            ...
                            <div class="col-md-6 blog-post" data-aos="fade-up">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    @auth()
                                    <form action="{{ route('post.like.store', $postRandom->id) }}" method="post">
                                        @csrf
                                        <span>{{ $post->liked_users_count }}</span>
                                        <button type="submit" class="border-0 bg-transparent">
                                            @if(auth()->user()->likedPosts->contains($postRandom->id))
                                            <i class="fas fa-heart"></i> <!-- like -->
                                            @else
                                            <i class="far fa-heart"></i>    
                                            @endif
                ...
                <div class="col-md-4 sidebar" data-aos="fade-left"><div class="widget widget-post-list">
